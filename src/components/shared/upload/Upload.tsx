...
function Upload(
  ...
  return (
    <div className={cn(wrapperClassName, "dark:bg-background/50")}>
      {label && (
        ...
        <div className="flex flex-col items-center @2xl:flex-row">
          ...
          {placeholderText || (
            <div className="@5xl::ps-10 pt-2 text-center @2xl:ps-5 @2xl:text-left">
              <h5 className="mb-2 text-sm font-bold text-gray-900 @2xl:text-base @3xl:mb-3 @3xl:text-lg dark:text-muted-foreground">
                Drop or select file
              </h5>
              <p className="text-sm leading-relaxed text-gray-900 dark:text-muted-foreground">
